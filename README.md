# DNS resolver & port scanner
in order to run, please do:
npm i

### results as text output:
node main.js hosts-ports.txt

### results as JSON output:
node main.js hosts-ports.txt --json

### results as JSON output using jq (https://stedolan.github.io/jq/download/):
node main.js hosts-ports.txt --json | jq
...
- Using node v12, write a port scanner
